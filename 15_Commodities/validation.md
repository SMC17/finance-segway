# Independent Validation: Commodities

## Validation identity

- Model ID and version: 15 / 2.2.0-evidence
...
Required engines: forward_curve, carry_storage, roll_yield, physical_balance, hedging, basis_risk, scenario_pnl.
Required perspectives: trader, producer, consumer, risk.
...
|---|---|---|---|
| commodities-public-wti-2023 | conventional | 2023-12-31 | pending |
| commodities-public-wti-april-2020 | adversarial | 2020-04-20 | recorded |
...
Recorded outcomes are stored in `15_Commodities/outcomes/outcome_log.csv`. A future test is permitted only when no realized observation yet exists and must name the preservation method and trigger.
