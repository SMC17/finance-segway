...
- Mathematical unit vectors remain tests only; no fabricated business case counts as evidence or maturity credit.
...
- Holder-election verification: all eight elections per scenario, independent Python payout re-derivation, seniority and conservation checks, mixed-election boundary cases, and payout monotonicity across exit values
...
- Participating preferred, participation caps, and unconverted SAFE claims remain unsupported and fail closed.
