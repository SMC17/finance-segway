# Independent Validation: Trade Finance

## Validation identity

- Model ID and version: 10 / 2.2.0-evidence
...
Required engines: cash_conversion, facility_utilization, lc_cost, factoring, counterparty_risk, country_risk.
Required perspectives: bank, borrower, insurer, dfi.
...
|---|---|---|---|
| trade-public-boeing-2019 | conventional | 2019-12-31 | recorded |
| trade-public-boeing-2020-stress | adversarial | 2020-12-31 | recorded |
...
Recorded outcomes are stored in `10_Trade_Finance/outcomes/outcome_log.csv`. A future test is permitted only when no realized observation yet exists and must name the preservation method and trigger.
