# Independent Validation: Fixed Income & Rates

## Validation identity

- Model ID and version: 21 / 2.1.0
...
- Engineering conclusion: **Approved with limitations for U.S. Treasury and plain-vanilla bond cases**
...
Required engines: zero_curve, bond_pricing, duration, convexity, key_rate_dv01, carry_roll, curve_scenarios, pnl_explain.
Required perspectives: trader, portfolio_manager, risk, treasury.
...
|---|---|---|---|
| rates-treasury-2025-12-01 | conventional | 2025-12-01 | recorded |
| rates-treasury-2022-shock | adversarial | 2022-10-21 | recorded |
...
Recorded outcomes are stored in `21_Fixed_Income_Rates/outcomes/outcome_log.csv`. A future test is permitted only when no realized observation yet exists and must name the preservation method and trigger.
