# Independent Validation: Merchant Banking

## Validation identity

- Model ID and version: 04 / 2.1.0
...
- Engineering conclusion: **Approved with limitations for public historical principal-investment cases**
...
Required perspectives: principal, lender, management, investment_committee.
...
|---|---|---|---|
| merchant-alleghany-2021 | conventional | 2022-02-24 | recorded |
| merchant-wework-2022 | adversarial | 2023-03-29 | recorded |
...
Recorded outcomes are stored in `04_Merchant_Banking/outcomes/outcome_log.csv`. A future test is permitted only when no realized observation yet exists and must name the preservation method and trigger.
