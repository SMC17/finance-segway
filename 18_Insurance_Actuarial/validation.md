# Independent Validation: Insurance & Actuarial

## Validation identity

- Model ID and version: 18 / 2.1.0
...
- Engineering conclusion: **Approved with limitations for public-company reserve and underwriting analysis**
...
Required engines: paid_triangle, chain_ladder, bornhuetter_ferguson, underwriting, embedded_value, capital_requirement, stress_testing.
Required perspectives: actuary, underwriter, management, regulator, rating_agency.
...
|---|---|---|---|
| insurance-chubb-2023 | conventional | 2024-02-23 | recorded |
| insurance-aig-2008 | adversarial | 2009-03-02 | recorded |
...
Recorded outcomes are stored in `18_Insurance_Actuarial/outcomes/outcome_log.csv`. A future test is permitted only when no realized observation yet exists and must name the preservation method and trigger.
