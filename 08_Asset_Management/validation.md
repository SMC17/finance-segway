# Independent Validation: Asset Management

## Validation identity

- Model ID and version: 08 / 2.2.0-evidence
...
Required engines: nav, subscriptions_redemptions, fee_waterfall, carry, attribution, liquidity_budget.
Required perspectives: gp, lp, risk, operations.
...
|---|---|---|---|
| am-public-blackrock-2023 | conventional | 2023-12-31 | pending |
| am-public-blackrock-2022-stress | adversarial | 2022-12-31 | recorded |
...
Recorded outcomes are stored in `08_Asset_Management/outcomes/outcome_log.csv`. A future test is permitted only when no realized observation yet exists and must name the preservation method and trigger.
