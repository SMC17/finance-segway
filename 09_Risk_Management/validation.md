# Independent Validation: Risk Management

## Validation identity

- Model ID and version: 09 / 2.1.0
...
- Engineering conclusion: **Approved with limitations for historical public-market portfolio cases**
...
Required engines: position_inventory, factor_covariance, factor_euler_var, position_component_var, var, expected_shortfall, stress_testing, liquidity_risk, pnl_explain, limit_monitoring.
Required perspectives: trader, risk, management, regulator.
...
|---|---|---|---|
| risk-fred-balanced-2024 | conventional | 2024-01-02 | recorded |
| risk-fred-covid-2020 | adversarial | 2020-03-16 | recorded |
...
Recorded outcomes are stored in `09_Risk_Management/outcomes/outcome_log.csv`. A future test is permitted only when no realized observation yet exists and must name the preservation method and trigger.
