# Independent Validation: Quantitative & Systematic

## Validation identity

- Model ID and version: 22 / 2.1.0
...
- Engineering conclusion: **Approved with limitations for public historical index-research cases**
...
Required engines: point_in_time_backtest, walk_forward, transaction_costs, capacity, performance, var_es, stress_testing, backtest_live_controls.
Required perspectives: researcher, portfolio_manager, risk, execution.
...
|---|---|---|---|
| quant-sp500-2019-2023 | conventional | 2023-12-29 | recorded |
| quant-sp500-2020-2024-capacity | adversarial | 2024-12-31 | recorded |
...
Recorded outcomes are stored in `22_Quantitative_Systematic/outcomes/outcome_log.csv`. A future test is permitted only when no realized observation yet exists and must name the preservation method and trigger.
