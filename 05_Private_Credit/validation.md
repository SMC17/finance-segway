# Independent Validation: Private Credit

## Validation identity

- Model ID and version: 05 / 3.0.0-evidence
...
Required engines: operating_case, cfads, debt_cash_schedule, covenants, yield_oid, recovery_lgd, downside_case.
Required perspectives: lender, sponsor, rating_agency, restructuring.
...
|---|---|---|---|
| credit-public-ares-2024 | conventional | 2024-12-31 | recorded |
| credit-public-yellow-2022-stress | adversarial | 2022-12-31 | recorded |
...
Recorded outcomes are stored in `05_Private_Credit/outcomes/outcome_log.csv`. A future test is permitted only when no realized observation yet exists and must name the preservation method and trigger.
