...
class PromotionGate:
    ...
    def __post_init__(self) -> None:
        ...
        if self.minimum_real_cases < 1:
            raise ValueError("A2 promotion requires at least one real case")
...
class PromotionDecision:
    ...
    limitations: tuple[str, ...] = (
        "A2 requires source-addressed real-case integration and independent review.",
        "A3 and A4 additionally require controlled use and maintained outcomes.",
    )
...
def assess_a2_promotion(
    ...
    *,
    ...
    real_case_evidence_ids: Iterable[str] = (),
    independent_reviewed: bool = False,
) -> PromotionDecision:
    real_case_ids = tuple(sorted(set(real_case_evidence_ids)))
    reasons: list[str] = []
    ...
    if len(real_case_ids) < gate.minimum_real_cases:
        reasons.append("source_addressed_real_case_required")
    if gate.require_independent_review and not independent_reviewed:
    ...
    evidence = {
        ...
        "real_case_evidence_ids": real_case_ids,
