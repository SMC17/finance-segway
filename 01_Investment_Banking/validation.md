# Independent Validation: Investment Banking

## Validation identity

- Model ID and version: 01 / 3.0.0-evidence
...
Required engines: three_statement, dcf, trading_comps, precedent_transactions.
Required perspectives: owner, board, advisor.
...
|---|---|---|---|
| ib-public-microsoft-linkedin-2016 | conventional | 2016-12-08 | recorded |
| ib-public-hp-autonomy-2012-stress | adversarial | 2012-10-31 | recorded |
...
Recorded outcomes are stored in `01_Investment_Banking/outcomes/outcome_log.csv`. A future test is permitted only when no realized observation yet exists and must name the preservation method and trigger.
