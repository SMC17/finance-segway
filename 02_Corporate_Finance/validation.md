# Independent Validation: Corporate Finance

## Validation identity

- Model ID and version: 02 / 3.0.0-evidence
...
Required engines: three_statement, capital_structure, liquidity, cost_of_capital.
Required perspectives: treasury, board, rating_agency.
...
|---|---|---|---|
| corporate-public-microsoft-2024 | conventional | 2024-06-30 | recorded |
| corporate-public-intel-2024-stress | adversarial | 2024-06-29 | recorded |
...
Recorded outcomes are stored in `02_Corporate_Finance/outcomes/outcome_log.csv`. A future test is permitted only when no realized observation yet exists and must name the preservation method and trigger.
