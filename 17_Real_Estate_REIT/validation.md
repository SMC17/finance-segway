# Independent Validation: Real Estate & REIT

## Validation identity

- Model ID and version: 17 / 2.2.0-evidence
...
Required engines: property_proforma, lease_roll, capex, debt, cap_rate, irr, reit_ffo_affo.
Required perspectives: owner, lender, tenant, appraiser.
...
|---|---|---|---|
| real-estate-public-realty-income-2023 | conventional | 2023-12-31 | recorded |
| real-estate-public-wework-2022-stress | adversarial | 2022-12-31 | recorded |
...
Recorded outcomes are stored in `17_Real_Estate_REIT/outcomes/outcome_log.csv`. A future test is permitted only when no realized observation yet exists and must name the preservation method and trigger.
