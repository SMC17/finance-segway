# Independent Validation: Private Equity

## Validation identity

- Model ID and version: 03 / 2.1.0
...
- Engineering conclusion: **Approved with limitations for historical public-case underwriting; human IC approval required for capital use**
...
Required engines: operating_model, sources_uses, working_capital, tax, revolver, multi_tranche_debt, pik, cash_sweep, covenants, management_equity, exit_waterfall, sensitivity.
Required perspectives: sponsor, lender, management, lp_ic.
...
|---|---|---|---|
| pe-public-home-depot-2023 | conventional | 2024-03-13 | recorded |
| pe-public-macys-2020 | adversarial | 2021-03-30 | recorded |
...
Recorded outcomes are stored in `03_Private_Equity/outcomes/outcome_log.csv`. A future test is permitted only when no realized observation yet exists and must name the preservation method and trigger.
