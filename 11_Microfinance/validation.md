# Independent Validation: Microfinance

## Validation identity

- Model ID and version: 11 / 2.2.0-evidence
...
Required engines: portfolio_rollforward, par30_90, vintage, credit_loss, oss_fss, funding_liquidity.
Required perspectives: lender, investor, regulator, dfi.
...
|---|---|---|---|
| microfinance-public-asa-2025 | conventional | 2025-12-31 | recorded |
| microfinance-public-asa-zambia-stress | adversarial | 2025-12-31 | pending |
...
Recorded outcomes are stored in `11_Microfinance/outcomes/outcome_log.csv`. A future test is permitted only when no realized observation yet exists and must name the preservation method and trigger.
