...
def enrich(workbook) -> None:
    ...
    rows = [
        ...
        (8, "LTV / CAC", "='Unit Economics'!C19", '=IF(ISNUMBER(C8),IF(C8>=3,"PASS",IF(C8>=1,"REVIEW","BREACH")),"REVIEW")', "Low unit economics require pricing, retention, channel, or cost remediation."),
