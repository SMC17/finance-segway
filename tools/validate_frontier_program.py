...
# "29" (Fund of Funds) reached M2 once it had two real, sourced cases
# (fof-public-hlpaf-2026, conventional; fof-public-skybridge-fy2023-stress,
# adversarial) satisfying tools/verify_release_shape.py's exactly-two-cases
# rule for M2+; "30" (ETF Construction & Management) launched at M2 with two
# real, sourced public instances; "31" (Software & SaaS) remains M1. All
# three are counted honestly below, not assumed to match the frontier
